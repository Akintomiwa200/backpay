...
const socialLinks = [
  {
    name: 'Twitter',
    href: 'https://twitter.com/laskadfinance',
    icon: (
  ...
  {
    name: 'Facebook',
    href: 'https://facebook.com/laskadfinance',
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
        <path
          fillRule="evenodd"
  ...
  {
    name: 'Instagram',
    href: 'https://instagram.com/laskadfinance',
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
        <path
          fillRule="evenodd"
  ...
  {
    name: 'LinkedIn',
    href: 'https://linkedin.com/company/laskadfinance',
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-12 pt-8 border-t border-gray-200 dark:border-gray-800">
          <p className="text-base text-gray-400 dark:text-gray-500 text-center">
            &copy; {new Date().getFullYear()} Laskad Technologies
            Ltd(RC-8597626). All rights reserved.
          </p>
        </div>
      </div>
    </footer>
