                    ...
                    <>
                      ...
                      <div className="lg:hidden lg:sidebar-expanded:block 2xl:block">
                        <ul className={`pl-8 mt-1 ${!open && 'hidden'}`}>
                          ...
                          <li className="mb-1 last:mb-0">
                            <SidebarLink href="/admin/dashboard/analytics">
                              <span className="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">
                                Analytics
                              </span>
                            </SidebarLink>
                          ...
                          <li className="mb-1 last:mb-0">
                            <SidebarLink href="/admin/dashboard/fintech">
                              <span className="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">
                                Fintech
                              </span>
                            </SidebarLink>
                  ...
                  return (
                    <>
                      ...
                      <div className="lg:hidden lg:sidebar-expanded:block 2xl:block">
                        <ul className={`pl-8 mt-1 ${!open && 'hidden'}`}>
                          <li className="mb-1 last:mb-0">
                            <SidebarLink href="/admin/ecommerce/customers">
                              <span className="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">
                                Customers
                              </span>
                            </SidebarLink>
                          ...
                          <li className="mb-1 last:mb-0">
                            <SidebarLink href="/admin/ecommerce/orders">
                              <span className="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">
                                Orders
                              </span>
                            </SidebarLink>
                          ...
                          <li className="mb-1 last:mb-0">
                            <SidebarLink href="/admin/ecommerce/invoices">
                              <span className="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">
                                Invoices
                              </span>
                            </SidebarLink>
                          ...
                          <li className="mb-1 last:mb-0">
                            <SidebarLink href="/admin/ecommerce/shop">
                              <span className="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">
                                Shop
                              </span>
                            </SidebarLink>
                          ...
                          <li className="mb-1 last:mb-0">
                            <SidebarLink href="/admin/ecommerce/shop-2">
                              <span className="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">
                                Shop 2
                              </span>
                            </SidebarLink>
                          ...
                          <li className="mb-1 last:mb-0">
                            <SidebarLink href="/admin/ecommerce/product">
                              <span className="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">
                                Single Product
                              </span>
                            </SidebarLink>
                          ...
                          <li className="mb-1 last:mb-0">
                            <SidebarLink href="/admin/ecommerce/cart">
                              <span className="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">
                                Cart
                              </span>
                            </SidebarLink>
                          ...
                          <li className="mb-1 last:mb-0">
                            <SidebarLink href="/admin/ecommerce/cart-2">
                              <span className="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">
                                Cart 2
                              </span>
                            </SidebarLink>
                          ...
                          <li className="mb-1 last:mb-0">
                            <SidebarLink href="/admin/ecommerce/cart-3">
                              <span className="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">
                                Cart 3
                              </span>
                            </SidebarLink>
                          ...
                          <li className="mb-1 last:mb-0">
                            <SidebarLink href="/admin/ecommerce/pay">
                              <span className="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">
                                Pay
                              </span>
                            </SidebarLink>
